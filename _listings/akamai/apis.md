...
- name: Akamai API List Performance Reports
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/performance/master/_listings/akamai/sla-api-v1-tests-slatestid-reports-performance-get.md
x-common:
- type: x-base
