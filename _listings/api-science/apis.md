...
- name: API Science Performance Report
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/performance/master/_listings/api-science/monitorsidperformance-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/performance/master/_listings/api-science/monitorsidperformance-get-openapi.md
- name: API Science
  x-api-slug: api-science
  description: Traditional monitoring services were designed long before APIs became
    core to modern applications. API Science is designed specifically for monitoring
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/performance/master/_listings/api-science/openapi.md
x-common:
- type: x-base-url
