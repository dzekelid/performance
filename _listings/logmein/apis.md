...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/performance/master/_listings/logmein/apis.md
...
- name: GoToWebinar API - Get performance for all webinar sessions
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/performance/master/_listings/logmein/organizerkeywebinarswebinarkeyperformance-get-openapi.md
- name: GoToWebinar API - Get session performance
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/performance/master/_listings/logmein/organizerkeywebinarswebinarkeysessionssessionkeyperformance-get-openapi.md
x-common:
- type: x-github
